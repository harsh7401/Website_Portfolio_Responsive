      ...
      <div ref={shellRef} className="relative z-1 group">
        ...
        >
          ...
          >
            ...
            >
              <img
                className="absolute inset-0 w-full h-full object-cover will-change-transform transition-transform duration-120 ease-out"
                src={avatarUrl}
            ...
            >
              {/* Title and role removed so the photo fills the card */}
            </div>
          </div>
        </section>
      </div>
